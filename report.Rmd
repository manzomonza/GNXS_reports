...
plot_prep_table$filepath = unname(sapply(plot_prep_table$filepath, shorten_name))
...
```{r}
na_vector = rowMeans(dataframeme)
mat_hc = overlap_coef_mat(dataframeme[is.na(na_vector),])
