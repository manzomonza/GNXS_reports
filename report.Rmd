...
assign_proper_name = function(filestring){
  parsestring = dirname(filestring)
  parsestring = rev(strsplit(parsestring, split = "/")[[1]])[1]
...
colnames(syns_mat) = unname(sapply(colnames(syns_mat), assign_proper_name))
colnames(nonsyn_mat) = unname(sapply(colnames(nonsyn_mat), assign_proper_name))
```
...
pheatmap::pheatmap(jac_distance_mat(syns_mat), 
